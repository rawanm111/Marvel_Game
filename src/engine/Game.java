...
//		try {
//         loadChampions("/Marvel-M3/Abilities.csv");
//		loadAbilities("/Marvel-M3/Champions.csv");
//		
//		}
//		catch(IOException x){
//	//		JOptionPane.showMessageDialog(this,"you con not move in this direction","Error",JOptionPane.ERROR_MESSAGE);
//		}
	...
	public void useLeaderAbility() throws LeaderNotCurrentException, LeaderAbilityAlreadyUsedException {
		...
		while(!targets.isEmpty())
			target.add((Damageable)targets.remove(0));
		//cleanup(target);
	}
